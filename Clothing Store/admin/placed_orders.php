...
function logEvent($message, $log_type = 'INFO') {
   $log_file = __DIR__ . '/../logs/app.log'; // Path to your log file
   $date = date('Y-m-d H:i:s');
   $log_message = "[$date] [$log_type]: $message\n";
...
if(isset($_POST['update_payment'])){
   ...
   logEvent("Payment status for order ID $order_id updated to $payment_status by admin ID $admin_id.", 'INFO');
...
if(isset($_GET['delete'])){
   ...
   // Log the order deletion
    logEvent("Order ID $delete_id deleted by admin ID $admin_id.", 'INFO');
